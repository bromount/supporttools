...
try:
    config = ConfigObj('result_new.txt')
...
for htmlfile in all_files:
    ...
    current_page_id = get_page_id(only_filename)
    ...
    for img in soup.findAll('img'):
      ...
      new_image = img['src'].replace("..","http://test.help.collab.net/topic/gitye")
...
#    print cleaned_content
    data = {"topic": {"body": cleaned_content}}
